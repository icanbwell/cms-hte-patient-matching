...
| 6 | [session_6](pending/session_6.md) | Line B: CMS v3.3 migration | 5 | M/L | pending — **on hold (Imran, 2026-08-16)**, also blocked on fetching the live CMS v3.3 spec content | Expand Table 2 to v3.3's 37 rules |
